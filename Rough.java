...
//
//                // Log the inserted data (for demonstration purposes)
...
//This code:
//
//        1. Defines variables for the roll IDs and names before the prepared statements.
//2. Logs the data to be inserted before setting the values in the prepared statements.
//        3. The rest of the code remains the same, creating the table and inserting the records.
//
//        **Output:**
//
//The output now includes the logged data, demonstrating the values used for insertion. Remember that this logging is for demonstration purposes and wouldn't typically be part of production code.
